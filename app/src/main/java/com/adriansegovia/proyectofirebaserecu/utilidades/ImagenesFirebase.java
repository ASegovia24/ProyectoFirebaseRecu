package com.adriansegovia.proyectofirebaserecu.utilidades;


import static com.adriansegovia.proyectofirebaserecu.utilidades.ImagenesBlobBitmap.bytes_to_bitmap;
...
import com.adriansegovia.proyectofirebaserecu.R;
    ...
    public static void descargarFoto(String nombre_carpeta, String nombre, ImageView imagendescargada) {
        ...
        islandRef.getBytes(tam_foto).addOnSuccessListener(new OnSuccessListener<byte[]>() {
            ...
            public void onFailure(@NonNull Exception exception) {
                ...
                imagendescargada.setImageResource(R.drawable.car_red);
            }
        });
    }
